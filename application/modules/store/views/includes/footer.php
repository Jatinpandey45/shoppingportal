<footer>
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="public/shoppping/assets/images/1.png" alt="">
						</a>
						<a href="#">
							<img src="public/shoppping/assets/images/2.png" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="public/shoppping/assets/images/pay2.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay5.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay1.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay4.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay6.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay3.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay7.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay8.png" alt="">
						</li>
						<li>
							<img src="public/shoppping/assets/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="public/shoppping/assets/js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src="public/shoppping/assets/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="public/shoppping/assets/js/minicart.js"></script>
	<script>
	...
	<script src="public/shoppping/assets/js/jquery-ui.js"></script>
	<script>
		//<![CDATA[ 
	...
	<script src="public/shoppping/assets/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
	...
	<!-- smoothscroll -->
	<script src="public/shoppping/assets/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="public/shoppping/assets/js/move-top.js"></script>
	<script src="public/shoppping/assets/js/easing.js"></script>
	<script>
	...
	<script src="public/shoppping/assets/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
