...
<link rel="stylesheet" href="public/vendors/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="public/vendors/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="public/vendors/js/jquery2.0.3.min.js"></script>
<script src="public/vendors/js/raphael-min.js"></script>
<script src="public/vendors/js/morris.js"></script>
</head>
<body>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/vendors/images/3.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/vendors/images/1.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/vendors/images/2.png"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="public/vendors/images/2.png">
                <span class="username"><?php echo $this->session->userdata('USER_LOGIN')['userinfo']['email']; ?></span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                <li><a href="vcmadmin/dashboard/logout"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
...
<!-- calendar -->
	<script type="text/javascript" src="public/vendors/js/monthly.js"></script>
